# @odczynflnpm/quos-reprehenderit-voluptates
...
To report a bug or request a feature please open an issue or pull request in [GitHub](https://github.com/odczynflnpm/quos-reprehenderit-voluptates). Please read the `Troublehsooting` section below *before* filing a bug.
...
```
$ npm install @odczynflnpm/quos-reprehenderit-voluptates --save
```

In your project file:
```javascript
const urlMetadata = require('@odczynflnpm/quos-reprehenderit-voluptates');

try {
  const url = 'https://www.npmjs.com/package/@odczynflnpm/quos-reprehenderit-voluptates';
...
const options = {
  ...
  requestHeaders: {
    'User-Agent': '@odczynflnpm/quos-reprehenderit-voluptates/3.0 (npm module)',
...
try {
  ...
  const response = await fetch('https://www.npmjs.com/package/@odczynflnpm/quos-reprehenderit-voluptates');
